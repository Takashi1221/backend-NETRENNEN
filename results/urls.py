...
from .views import CombinedResultsViewSet, RaceResultsViewSet, RaceNumberViewSet, HorseEachResultsiViewSet, results_by_date, submit_passing_order, DataAnalysisViewSet
...
router.register(r'dataanalysis', DataAnalysisViewSet, basename='dataanalysis')
